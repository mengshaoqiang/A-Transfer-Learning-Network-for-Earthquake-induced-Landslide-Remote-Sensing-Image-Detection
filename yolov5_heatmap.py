...
class yolov5_heatmap:
    ...
    def __call__(self, img_path, save_path):
        ...
        print('post_resulte',post_result)
        for i in trange(int(post_result.size(0) * self.ratio)):
            ...
            print('cam_image',cam_image)
            cam_image.save(f'{save_path}/{i}.png')


def get_params():
    params = {
        'weight': 'runs/train/exp153/weights/best.pt',
        'cfg': 'configs/yolov5-standard/yolov5s.yaml',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/remote-home/2210975/project/yolo-slide/dataset/slide-400-67/val/images/zj002.png', 'result')
